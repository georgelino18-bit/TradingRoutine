...
**Portfolio:** UNAVAILABLE (Alpaca 403, week 19) | **Cash:** ~$100,000 est | **Day P&L:** N/A | **Phase P&L:** ~0%

| Ticker | Shares | Entry | Close | Day Chg | Unrealized P&L | Stop |
|--------|--------|-------|-------|---------|----------------|------|
| — | — | — | — | — | — | — |

**Actions:** None — API blocked, no confirmed positions.
**Note:** SLB order `6c529f05-19c5-4078-ba9d-9fb42bc7ee15` (May 15) remains unconfirmed; assumed ghost. Egress proxy blocks `paper-api.alpaca.markets:443` at org level. Week 19 of same blocker.
