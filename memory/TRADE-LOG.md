...
## 2026-07-22 — EOD Snapshot (Day ~50, Wednesday)
**Portfolio:** N/A | **Cash:** N/A | **Day P&L:** N/A | **Phase P&L:** N/A
...
**Notes:** PERSISTENT API BLOCKAGE — sandbox proxy continues to reject outbound connections to both paper-api.alpaca.markets and api.clickup.com (HTTP 403 CONNECT tunnel denied, policy denial). No live account data retrievable; no ClickUp message sent. Last known state: Day 0 = $100,000 cash, 0 confirmed positions (SLB order from 2026-05-15 status unknown). This issue has been recurring since May 14. Manual action required: either whitelist this environment's egress IP in Alpaca/ClickUp network settings, or switch to an environment with unrestricted outbound HTTPS to those hosts.
