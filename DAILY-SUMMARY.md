...
---
## 2026-09-24 13:47 UTC (fallback — curl network error)
MARKET-OPEN BLOCKED: Alpaca API unreachable (egress proxy 403). No trades placed. Manual intervention required.
