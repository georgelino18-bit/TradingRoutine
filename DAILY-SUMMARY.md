...
---
## 2026-06-03 13:36 UTC (fallback — HTTP 403)
MARKET-OPEN BLOCKED: Alpaca API returning 403 Host not in allowlist. Perplexity also blocked. No trades can be placed or verified. Manual action required — whitelist this sandbox IP in Alpaca paper account settings.
