...
---
## 2026-09-10 17:04 UTC (fallback — curl network error)
MIDDAY SCAN 2026-09-10: Alpaca API BLOCKED — egress proxy denying paper-api.alpaca.markets (403). Cannot pull positions, orders, or execute trades. Same issue since May 2026. Manual intervention required: whitelist sandbox IP in Alpaca paper account or reconfigure proxy.
