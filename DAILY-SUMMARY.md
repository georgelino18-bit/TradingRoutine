...
---
## 2026-09-25 21:08 UTC (fallback — curl network error)
Week ending 2026-09-25
Portfolio: $100,000 (0.00% week, 0.00% phase — API blocked wk 19)
vs S&P 500: -0.63% (S&P +0.63%)
Trades: 0 (W:0 / L:0 / open:0)
Best: N/A  Worst: N/A
One-line takeaway: Egress proxy (org policy) still blocking Alpaca + Perplexity — 19 weeks zero execution; must resolve at infrastructure level.
Grade: D
