...
---
## 2026-09-07 13:35 UTC (fallback — curl network error)
ALERT 2026-09-07 market-open: Alpaca API blocked (egress proxy 403 — paper-api.alpaca.markets not in allowlist). Cannot read account/positions or place orders. No trades executed. Manual action required: whitelist sandbox IP in Alpaca paper account settings.
