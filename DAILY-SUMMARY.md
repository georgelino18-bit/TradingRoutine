...
---
## 2026-05-20 17:01 UTC (fallback — HTTP 403)
MIDDAY SCAN 2026-05-20: API BLOCKED — Alpaca 403 host-not-in-allowlist persists. No positions data available. No action taken. Manual intervention required.
