...
---
## 2026-08-25 17:04 UTC (fallback — curl network error)
MIDDAY SCAN 2026-08-25: Alpaca API 403 (IP not whitelisted). Cannot read positions/orders. No action possible. Manual check required.
