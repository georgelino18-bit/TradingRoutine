...
---
## 2026-08-31 13:35 UTC (fallback — curl network error)
ALERT 2026-08-31 market-open: Alpaca API blocked by egress proxy (403) — no account data, no trades possible. Same sandbox IP restriction as May sessions. Manual action required: whitelist sandbox IP in Alpaca paper account settings.
