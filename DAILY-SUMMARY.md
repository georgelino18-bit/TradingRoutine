...
---
## 2026-08-31 17:05 UTC (fallback — curl network error)
MIDDAY SCAN 2026-08-31: Alpaca API blocked (403 egress policy). Cannot read positions, orders, or place trades. API access has been blocked since Day 1 (2026-05-14). MANUAL ACTION REQUIRED: Resolve network access to paper-api.alpaca.markets.
