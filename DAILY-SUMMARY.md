...
---
## 2026-09-03 17:03 UTC (fallback — curl network error)
midday scan 2026-09-03: Alpaca API blocked by egress proxy (403). Cannot pull positions, orders, or execute any trades. Manual intervention required.
