...
---
## 2026-08-14 17:06 UTC (fallback — curl network error)
MIDDAY SCAN 2026-08-14: BLOCKED — proxy denies Alpaca + Perplexity. 0 positions accessible. No trades possible. Manual intervention required to whitelist sandbox IP.
